...
namespace SmartParking.Client.Common
{
    public class PasswordHelper
    {
        ...
        private static void OnPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!_isUpdating)
                (d as PasswordBox).Password = e.NewValue.ToString(); // PasswordProperty --> e.NewValue --> PasswordBox.Password
            pb.PasswordChanged += Pb_PasswordChanged;
        }
        ...
        private static void Pb_PasswordChanged(object sender, RoutedEventArgs e)
        {
            ...
            _isUpdating = true;
            SetPassword(pb, pb.Password); // 对象 和 其属性   // PasswordProperty <-- value  <-- PasswordBox.Password
