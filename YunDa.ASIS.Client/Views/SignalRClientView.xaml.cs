...
namespace YunDa.ASIS.Client.Views
{
    /// <summary>
    /// SignalRClientView.xaml 的交互逻辑
    /// </summary>
    public partial class SignalRClientView : UserControl
    {
        HubConnection connection;
        private string Title;

        public SignalRClientView()
        {
            InitializeComponent();

            var bd = new HubConnectionBuilder();
